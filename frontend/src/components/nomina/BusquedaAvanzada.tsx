                  ...
                  <div className="h-28 w-full">
                    <RechartsResponsiveContainer width="100%" height="100%">
                      <RechartsBarChart
                        layout="vertical"
                        data={[
                          { name: 'Percepciones', monto: dataAdvanced.summary.totalPercepciones },
                          { name: 'Deducciones', monto: dataAdvanced.summary.totalDeducciones },
                          { name: 'Neto Recibido', monto: dataAdvanced.summary.totalNeto }
                        ]}
